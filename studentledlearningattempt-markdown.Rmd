...
that any unknown point can best be described by similar points nearby. 
...
class 1. This modeling technique is extremely easy to use and understand

## tl;dr

This tutorial servesas an introduction to the _k_-Nearest Neighbors classification tecnique and covers:
...
6. [Learn More](#learnmore): Visit these resources to learn more about _k_ -NN.
...
located at the following link. Make sure you save this file as an .RData file
type. Additionally, the `tidyverse`, `class`, 'leap', and `ggplot2` packages will be
...
createDownloadURI("voice", filename = "voicedata", textHTM = "Click here to download the data. Make sure you save the file as voicedata.RData")
...
We can validate that by plotting the average accuracy vector over
